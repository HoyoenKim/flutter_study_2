...
OrderProdutModel _$OrderProdutModelFromJson(Map<String, dynamic> json) =>
    OrderProdutModel(
...
Map<String, dynamic> _$OrderProdutModelToJson(OrderProdutModel instance) =>
    <String, dynamic>{
      'id': instance.id,
      'name': instance.name,
...
OrderProductAndCountModel _$OrderProductAndCountModelFromJson(
    ...
    OrderProductAndCountModel(
      product:
          OrderProdutModel.fromJson(json['product'] as Map<String, dynamic>),
